...
const AlertListScreenD = ({ navigation }) => {
  ...
  const handlePress = (alerte) => {
    navigation.navigate('AlertDetailD', { alerte });
  };
...
const styles = StyleSheet.create({
  ...
  content: {
    ...
    marginTop: 25, // 🔥 input légèrement descendu
  },
...
export default AlertListScreenD;